...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.85\textwidth]{results/plots/trajectories.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.85\textwidth]{results/plots/rho_trial1.png}
  \caption{Distance to obstacle versus time for trial 1, showing safe clearance throughout the run.}
  \label{fig:rho}
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.85\textwidth]{results/plots/vw_trial1.png}
  \caption{Linear velocity $v$ and angular velocity $\omega$ versus time for trial 1.}
  \label{fig:vw}
\end{figure}
...
\begin{enumerate}
  ...
  \item Run \texttt{analysis/analyze.py} to compute metrics and generate plots in \texttt{results/plots/}.
